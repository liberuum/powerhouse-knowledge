...
tools:
  ...
  - Agent
---
<!-- GENERATED from AGENT.md (sha256:3acf5966923f7bc2) by scripts/build-agent.mjs — edit AGENT.md, not this file -->
...
4. **Never batch dependent operations**: `docs apply` does not preserve ordering guarantees you need — pipeline ops (ADD_TASK → ASSIGN_TASK → ADVANCE_PHASE) go one at a time via `docs mutate`.
